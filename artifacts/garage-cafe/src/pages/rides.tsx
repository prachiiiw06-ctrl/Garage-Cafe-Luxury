    ...
    <div className="min-h-screen bg-[#111111] font-['Poppins'] pt-20">
      ...
      <div className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <FadeUp>
            <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">Ride With Us</span>
            <h1 className="font-['Bebas_Neue'] text-6xl sm:text-8xl text-white mt-3 tracking-wider">
              BOOK YOUR <span className="text-[#D97706]">RIDE</span>
            </h1>
      ...
      <div className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <FadeUp className="text-center mb-12">
            <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">Choose Your Ride</span>
            <h2 className="font-['Bebas_Neue'] text-5xl text-white mt-3 tracking-wider">
              RIDE <span className="text-[#D97706]">TYPES</span>
            </h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {rideTypes.map((ride, i) => (
              <FadeUp key={ride.name} delay={i * 0.1}>
                <div className="group h-full p-6 bg-white/5 border border-white/8 hover:border-[#D97706]/40 rounded-2xl text-center transition-all duration-300 hover:-translate-y-1">
                  <div className="w-14 h-14 mx-auto rounded-xl bg-[#D97706]/10 border border-[#D97706]/20 flex items-center justify-center text-[#D97706] mb-4 group-hover:bg-[#D97706]/20 transition-colors">
                    {ride.icon}
                  </div>
                  <h4 className="font-['Playfair_Display'] text-white font-bold text-lg mb-1">{ride.name}</h4>
                  <p className="text-[#D97706]/70 text-xs font-['Montserrat'] font-semibold tracking-wider uppercase mb-3">{ride.duration}</p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-black/30 border border-white/10 focus:border-[#D97706] rounded-xl px-4 py-3 text-white text-sm placeholder-white/25 outline-none transition-colors"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-black/30 border border-white/10 focus:border-[#D97706] rounded-xl px-4 py-3 text-white text-sm outline-none transition-colors"
                  >
                    {rideTypes.map((r) => (
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-black/30 border border-white/10 focus:border-[#D97706] rounded-xl px-4 py-3 text-white text-sm outline-none transition-colors [color-scheme:dark]"
                    />
                  </div>
                  <div>
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-3 w-full bg-[#D97706] hover:bg-[#B87333] text-white font-['Montserrat'] font-semibold tracking-widest uppercase py-4 rounded-full transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-[#D97706]/30 text-sm mt-2"
                >
