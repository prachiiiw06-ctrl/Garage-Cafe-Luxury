    ...
    <div className="min-h-screen bg-[#111111] font-['Poppins'] pt-20">
      ...
      <div className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <FadeUp>
            <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">Find Us</span>
            <h1 className="font-['Bebas_Neue'] text-6xl sm:text-8xl text-white mt-3 tracking-wider">
              VISIT <span className="text-[#D97706]">THE GARAGE</span>
            </h1>
          ...
          <FadeUp>
            ...
            <div className="flex gap-3 mt-4">
              <a
                ...
                className="flex-1 bg-[#D97706] hover:bg-[#B87333] text-white font-['Montserrat'] font-semibold tracking-wider uppercase text-sm py-3 rounded-full text-center transition-all hover:shadow-lg hover:shadow-[#D97706]/30 hover:scale-105"
              >
                Get Directions
              </a>
              <a
                href="tel:+91XXXXXXXXXX"
                className="flex-1 border-2 border-white/20 hover:border-[#D97706] text-white hover:text-[#D97706] font-['Montserrat'] font-semibold tracking-wider uppercase text-sm py-3 rounded-full text-center transition-all hover:scale-105"
              >
                Call Now
              </a>
            </div>
          ...
          <div className="space-y-4">
            {infoCards.map((card, i) => (
              <FadeUp key={card.label} delay={i * 0.1}>
                <div className="group flex items-start gap-4 p-5 bg-white/5 backdrop-blur-sm border border-white/10 hover:border-[#D97706]/40 rounded-xl transition-all duration-300 hover:-translate-y-0.5">
                  <div className="w-11 h-11 rounded-xl bg-[#D97706]/10 border border-[#D97706]/20 flex items-center justify-center text-[#D97706] flex-shrink-0 group-hover:bg-[#D97706]/20 transition-colors">
                    {card.icon}
                  </div>
                  <div>
                    ...
                    {card.note && (
                      <div className="text-[#D97706]/60 text-xs mt-1 italic">{card.note}</div>
                    )}
                  </div>
                </div>
              </FadeUp>
      ...
      <div className="py-16 px-4 bg-[#0d0d0d]">
        <div className="max-w-6xl mx-auto">
          <FadeUp className="text-center mb-12">
            <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">How We Serve</span>
            <h2 className="font-['Bebas_Neue'] text-5xl text-white mt-3 tracking-wider">
              OUR <span className="text-[#D97706]">SERVICES</span>
            </h2>
            <div className="w-16 h-0.5 bg-[#D97706] mx-auto mt-4" />
          </FadeUp>

          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {services.map((s, i) => (
              <FadeUp key={s.name} delay={i * 0.1}>
                <div className="group p-6 bg-white/5 border border-white/5 hover:border-[#D97706]/30 rounded-2xl text-center transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="py-20 px-4 bg-[#111111]">
        <div className="max-w-6xl mx-auto">
          <FadeUp className="text-center mb-12">
            <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">Instagram</span>
            <h2 className="font-['Bebas_Neue'] text-5xl text-white mt-3 tracking-wider">
              GARAGE <span className="text-[#D97706]">MOMENTS</span>
            </h2>
            <div className="w-16 h-0.5 bg-[#D97706] mx-auto mt-4" />
          </FadeUp>
        ...
        <div className="max-w-2xl mx-auto text-center">
          <FadeUp>
            <h2 className="font-['Bebas_Neue'] text-5xl text-white tracking-wider">
              HAVE <span className="text-[#D97706]">QUESTIONS?</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:+91XXXXXXXXXX">
                <button className="border-2 border-white/20 hover:border-[#D97706] text-white hover:text-[#D97706] font-['Montserrat'] font-semibold tracking-wider uppercase px-7 py-3.5 rounded-full transition-all hover:scale-105 text-sm">
                  Call Now
                </button>
              </a>
            </div>
