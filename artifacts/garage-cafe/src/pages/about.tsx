    ...
    <div className="min-h-screen bg-[#111111] font-['Poppins'] pt-20">
      ...
      <div className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <FadeUp>
            <div className="relative bg-gradient-to-br from-[#D97706]/10 to-[#B87333]/5 border border-[#D97706]/20 rounded-3xl p-10 text-center overflow-hidden">
              ...
              <div className="w-12 h-0.5 bg-[#D97706] mx-auto mt-6" />
              <p className="text-[#D97706] font-['Montserrat'] font-semibold tracking-wider mt-3 text-sm">— The Founders, The Garage Cafe</p>
            </div>
          </FadeUp>
        </div>
      </div>
      ...
      <div className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <FadeUp className="text-center mb-16">
            <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">How We Got Here</span>
            <h2 className="font-['Bebas_Neue'] text-5xl sm:text-6xl text-white mt-3 tracking-wider">
              OUR <span className="text-[#D97706]">JOURNEY</span>
            </h2>
            <div className="w-20 h-0.5 bg-[#D97706] mx-auto mt-4" />
          </FadeUp>
          ...
          <div className="relative">
            ...
            <div className="hidden lg:block absolute left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-[#D97706]/50 via-[#D97706]/30 to-transparent -translate-x-1/2" />
                  ...
                  <div className={`grid lg:grid-cols-2 gap-8 lg:gap-16 items-center ${i % 2 === 1 ? "lg:direction-rtl" : ""}`}>
                    ...
                    <div className={i % 2 === 1 ? "lg:order-2" : ""}>
                      <div className="flex items-center gap-4 mb-4">
                        <span className="font-['Bebas_Neue'] text-6xl text-[#D97706]/20 leading-none">{item.year}</span>
                        <div className="flex-1 h-px bg-[#D97706]/20" />
                        <div className="hidden lg:block w-3 h-3 rounded-full bg-[#D97706] border-4 border-[#111111] ring-1 ring-[#D97706]" />
                      </div>
                    ...
                    <div className={`relative ${i % 2 === 1 ? "lg:order-1" : ""}`}>
                      ...
                      <div className="absolute -bottom-2 -right-2 w-20 h-20 border border-[#D97706]/20 rounded-2xl -z-10" />
                    </div>
                  </div>
                </FadeUp>
              ))}
      ...
      <div className="py-20 px-4 bg-[#0d0d0d]">
        <div className="max-w-6xl mx-auto">
          <FadeUp className="text-center mb-14">
            <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">What We Stand For</span>
            <h2 className="font-['Bebas_Neue'] text-5xl sm:text-6xl text-white mt-3 tracking-wider">
              OUR <span className="text-[#D97706]">VALUES</span>
            </h2>
            <div className="w-20 h-0.5 bg-[#D97706] mx-auto mt-4" />
          </FadeUp>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <FadeUp key={v.title} delay={i * 0.07}>
                <div className="p-6 bg-white/5 border border-white/5 hover:border-[#D97706]/30 rounded-2xl transition-all duration-300 hover:-translate-y-1 group">
      ...
      <div className="py-20 px-4 bg-[#111111]">
        <div className="max-w-6xl mx-auto">
          <FadeUp className="text-center mb-14">
            <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">Inside The Garage</span>
            <h2 className="font-['Bebas_Neue'] text-5xl sm:text-6xl text-white mt-3 tracking-wider">
              EXPERIENCE THE <span className="text-[#D97706]">AMBIENCE</span>
            </h2>
            <div className="w-20 h-0.5 bg-[#D97706] mx-auto mt-4" />
          </FadeUp>
      ...
      <div className="py-20 px-4 bg-[#0d0d0d] text-center">
        <FadeUp>
          <h2 className="font-['Bebas_Neue'] text-5xl text-white tracking-wider">
            COME <span className="text-[#D97706]">MEET US</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
            <a href="/visit">
              <button className="bg-[#D97706] hover:bg-[#B87333] text-white font-['Montserrat'] font-semibold tracking-widest uppercase px-8 py-4 rounded-full transition-all hover:shadow-lg hover:shadow-[#D97706]/30 hover:scale-105 text-sm">
                Visit Us
              </button>
            </a>
            <a href="/menu">
              <button className="border-2 border-white/20 hover:border-[#D97706] text-white hover:text-[#D97706] font-['Montserrat'] font-semibold tracking-widest uppercase px-8 py-4 rounded-full transition-all hover:scale-105 text-sm">
                Explore Menu
              </button>
            </a>
          </div>
