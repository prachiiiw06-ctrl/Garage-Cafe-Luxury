    ...
    <div className="font-['Poppins']">
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          <motion.div
            ...
            className="inline-block border border-[#D97706]/50 text-[#D97706] text-xs tracking-[0.4em] uppercase font-['Montserrat'] font-semibold px-5 py-2 rounded-full mb-6 bg-[#D97706]/10 backdrop-blur-sm"
          >
          ...
          >
            FUEL YOUR RIDE.
            <br />
            <span className="text-[#D97706]">FEED YOUR SOUL.</span>
          </motion.h1>
          ...
          >
            Where handcrafted coffee meets delicious comfort food in a one-of-a-kind garage-inspired café experience.
          </motion.p>
          ...
          >
            <Link href="/menu">
              <button className="bg-[#D97706] hover:bg-[#B87333] text-white font-['Montserrat'] font-semibold tracking-widest uppercase px-8 py-4 rounded-full transition-all duration-300 hover:shadow-2xl hover:shadow-[#D97706]/40 hover:scale-105 text-sm">
                Explore Menu
              </button>
            </Link>
            <Link href="/visit">
              <button className="border-2 border-white/60 hover:border-[#D97706] text-white hover:text-[#D97706] font-['Montserrat'] font-semibold tracking-widest uppercase px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 text-sm backdrop-blur-sm">
                Visit Us
              </button>
            </Link>
          </motion.div>
        ...
        >
          ...
          <div className="w-px h-10 bg-gradient-to-b from-[#D97706] to-transparent animate-pulse" />
        </motion.div>
      </section>

      {/* ======= STATS BAR ======= */}
      <section className="bg-[#D97706] py-6">
        ...
        <div className="max-w-6xl mx-auto">
          <Section>
            <FadeUp className="text-center mb-16">
              <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">Why Us</span>
              <h2 className="font-['Bebas_Neue'] text-5xl sm:text-6xl text-white mt-3 tracking-wider">
                THE GARAGE <span className="text-[#D97706]">DIFFERENCE</span>
              </h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((f, i) => (
                <FadeUp key={f.title} delay={i * 0.1}>
                  <div className="group relative p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 hover:border-[#D97706]/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#D97706]/10 text-center overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-[#D97706] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  </div>
                </FadeUp>
              ))}
            </div>
      ...
      <section className="py-24 px-4 bg-[#0d0d0d]">
        <div className="max-w-7xl mx-auto">
          <Section>
            <FadeUp className="text-center mb-16">
              <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">Our Specials</span>
              <h2 className="font-['Bebas_Neue'] text-5xl sm:text-6xl text-white mt-3 tracking-wider">
                CRAFTED WITH <span className="text-[#D97706]">PASSION</span>
              </h2>
              <div className="w-20 h-0.5 bg-[#D97706] mx-auto mt-4" />
            ...
            <FadeUp className="text-center mt-12">
              <Link href="/menu">
                <button className="border-2 border-[#D97706] text-[#D97706] hover:bg-[#D97706] hover:text-white font-['Montserrat'] font-semibold tracking-widest uppercase px-10 py-4 rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-[#D97706]/30 hover:scale-105 text-sm">
                  View Full Menu
                </button>
              </Link>
            </FadeUp>
          ...
          <Section className="grid lg:grid-cols-2 gap-16 items-center">
            <FadeUp>
              <div className="relative">
                <div className="absolute -inset-4 bg-[#D97706]/10 rounded-3xl blur-2xl" />
                <div className="relative rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute bottom-5 left-5 right-5">
                    <div className="bg-black/60 backdrop-blur-md border border-white/10 rounded-xl p-4">
                      <div className="font-['Bebas_Neue'] text-2xl text-[#D97706] tracking-wider">Where Riders Belong</div>
                      <div className="text-white/70 text-xs font-['Poppins'] mt-1">Motorcycles. Coffee. Community.</div>
                    </div>
                  </div>
                </div>
                <div className="absolute -top-4 -right-4 w-24 h-24 border-2 border-[#D97706]/30 rounded-full" />
                <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-[#D97706]/10 rounded-full" />
              </div>
            </FadeUp>

            <FadeUp delay={0.2}>
              <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">Our Story</span>
              <h2 className="font-['Bebas_Neue'] text-5xl sm:text-6xl text-white mt-3 tracking-wider leading-none">
                MORE THAN JUST
                <br />
                <span className="text-[#D97706]">A CAFE</span>
              </h2>
              <div className="w-16 h-0.5 bg-[#D97706] mt-5 mb-6" />
              ...
              <Link href="/about">
                <button className="mt-8 text-[#D97706] hover:text-[#B87333] font-['Montserrat'] font-semibold text-sm tracking-wider uppercase flex items-center gap-3 transition-colors group">
                  Read Our Full Story
        ...
        <div className="max-w-6xl mx-auto">
          <Section>
            <FadeUp className="text-center mb-14">
              <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">Gallery</span>
              <h2 className="font-['Bebas_Neue'] text-5xl sm:text-6xl text-white mt-3 tracking-wider">
                OUR GARAGE <span className="text-[#D97706]">MOMENTS</span>
              </h2>
              <div className="w-20 h-0.5 bg-[#D97706] mx-auto mt-4" />
            </FadeUp>
            ...
            <FadeUp className="text-center mt-10">
              <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
                <button className="inline-flex items-center gap-3 border-2 border-[#D97706] text-[#D97706] hover:bg-[#D97706] hover:text-white font-['Montserrat'] font-semibold tracking-widest uppercase px-8 py-3.5 rounded-full transition-all duration-300 hover:scale-105 text-sm">
        ...
        <div className="max-w-4xl mx-auto">
          <Section>
            <FadeUp className="text-center mb-6">
              <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">Guest Reviews</span>
              <h2 className="font-['Bebas_Neue'] text-5xl sm:text-6xl text-white mt-3 tracking-wider">
                WHAT THEY <span className="text-[#D97706]">SAY</span>
              </h2>
              <div className="flex items-center justify-center gap-2 mt-4">
                {[1,2,3,4,5].map(s => <span key={s} className="text-[#D97706] text-xl">★</span>)}
            ...
            <FadeUp>
              <div className="relative">
                <div className="absolute -inset-1 bg-gradient-to-r from-[#D97706]/20 via-[#B87333]/10 to-[#D97706]/20 rounded-3xl blur-xl" />
                <div className="relative bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 sm:p-12 text-center min-h-[220px] flex flex-col items-center justify-center">
                  <svg className="w-10 h-10 text-[#D97706]/40 mb-4" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <motion.div
                    ...
                    className="mt-6"
                  >
                    <div className="w-12 h-0.5 bg-[#D97706] mx-auto mb-3" />
                    <div className="font-['Montserrat'] font-semibold text-[#D97706] tracking-wider">
                      — {reviews[currentReview].name}
                    </div>
                    <div className="flex justify-center gap-1 mt-2">
                      {[...Array(reviews[currentReview].stars)].map((_, i) => (
                        <span key={i} className="text-[#D97706]">★</span>
                      ))}
                    </div>
                  </motion.div>
                </div>
              ...
              <div className="flex justify-center gap-2 mt-6">
                {reviews.map((_, i) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-all duration-300 ${i === currentReview ? "w-6 bg-[#D97706]" : "bg-white/20"}`}
                  />
                ))}
              </div>
            </FadeUp>
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <Section>
            <FadeUp>
              <span className="text-[#D97706] font-['Montserrat'] font-semibold text-xs tracking-[0.4em] uppercase">Come Visit</span>
              <h2 className="font-['Bebas_Neue'] text-5xl sm:text-7xl text-white mt-3 tracking-wider leading-none">
                READY FOR YOUR NEXT
                <br />
                <span className="text-[#D97706]">COFFEE BREAK?</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
                <Link href="/visit">
                  <button className="bg-[#D97706] hover:bg-[#B87333] text-white font-['Montserrat'] font-semibold tracking-widest uppercase px-8 py-4 rounded-full transition-all hover:shadow-2xl hover:shadow-[#D97706]/40 hover:scale-105 text-sm">
                    Visit Cafe
                  </button>
                </Link>
                <Link href="/menu">
                  <button className="border-2 border-white/30 hover:border-[#D97706] text-white hover:text-[#D97706] font-['Montserrat'] font-semibold tracking-widest uppercase px-8 py-4 rounded-full transition-all hover:scale-105 text-sm">
                    Explore Menu
                  </button>
                </Link>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            <div className="lg:col-span-2">
              ...
              <div className="text-[#D97706] text-xs font-['Montserrat'] font-semibold tracking-[0.4em] mb-4">FUEL YOUR RIDE. FEED YOUR SOUL.</div>
              ...
              <div className="flex gap-4 mt-6">
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer"
                  className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center hover:border-[#D97706] hover:text-[#D97706] text-white/60 transition-colors">
              ...
              <div className="space-y-3">
                {[["Home", "/"], ["Menu", "/menu"], ["About", "/about"], ["Visit Us", "/visit"]].map(([label, href]) => (
                  <Link key={href} href={href}>
                    <div className="text-white/50 hover:text-[#D97706] text-sm font-['Poppins'] cursor-pointer transition-colors flex items-center gap-2 group">
                      <div className="w-0 group-hover:w-3 h-px bg-[#D97706] transition-all duration-300" />
                      {label}
                    </div>
                  </Link>
                ))}
            ...
            <div>
              ...
              <div className="space-y-2 text-sm font-['Poppins']">
                <div className="flex justify-between text-white/60">
                  <span>All Days</span>
                  <span className="text-[#D97706]">Open</span>
                </div>
