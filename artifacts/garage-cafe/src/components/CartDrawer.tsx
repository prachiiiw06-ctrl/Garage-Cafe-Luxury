            ...
            <div className="flex-1 overflow-y-auto px-6 py-4 space-y-3">
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center py-20">
                  ...
                  <button
                    onClick={closeCart}
                    className="mt-5 text-[#D97706] text-sm font-['Montserrat'] font-semibold tracking-wider underline underline-offset-4"
                  >
                    Browse Menu
                  </button>
                </div>
                        ...
                        <div className="flex items-center gap-3 mt-3">
                          <div className="flex items-center gap-2 bg-black/30 rounded-full px-1 py-1">
                            <button
                              ...
                              className="w-6 h-6 rounded-full bg-white/10 hover:bg-[#D97706]/30 text-white flex items-center justify-center transition-colors text-sm font-bold"
                            >
                              −
                            </button>
                            ...
                            <button
                              onClick={() => updateQty(item.name, 1)}
                              className="w-6 h-6 rounded-full bg-[#D97706] hover:bg-[#B87333] text-white flex items-center justify-center transition-colors text-sm font-bold"
                            >
                              +
                            </button>
                          </div>
            ...
            {items.length > 0 && (
              <div className="border-t border-white/10 px-6 py-5 space-y-3">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-3 w-full bg-[#E23744] hover:bg-[#c42f3b] text-white font-['Montserrat'] font-semibold tracking-widest uppercase py-4 rounded-full transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-[#E23744]/30 text-sm"
                >
