          ...
          >
            <div className="flex items-center justify-between px-6 py-5 border-b border-white/10">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-[#B87333]/15 flex items-center justify-center">
                  <svg className="w-4 h-4 text-[#B87333]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-4 space-y-3">
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center py-20">
                  ...
                  <button
                    onClick={closeCart}
                    className="mt-5 text-[#B87333] text-sm font-['Montserrat'] font-semibold tracking-wider underline underline-offset-4"
                  >
                    Browse Shop
                  </button>
                </div>
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-2">
                            <div>
                              ...
                              <p className="text-[#B87333] text-xs font-['Montserrat'] font-semibold mt-0.5">₹{item.price}</p>
                            </div>
                            <button
                          ...
                          <div className="flex items-center gap-2 bg-black/30 rounded-full px-1 py-1 mt-2 w-fit">
                            <button
                              ...
                              className="w-6 h-6 rounded-full bg-white/10 hover:bg-[#B87333]/30 text-white flex items-center justify-center transition-colors text-sm font-bold"
                            >
                              −
                            </button>
                            ...
                            <button
                              onClick={() => updateQty(item.id, 1)}
                              className="w-6 h-6 rounded-full bg-[#B87333] hover:bg-[#a05e29] text-white flex items-center justify-center transition-colors text-sm font-bold"
                            >
                              +
                            </button>
                          </div>
